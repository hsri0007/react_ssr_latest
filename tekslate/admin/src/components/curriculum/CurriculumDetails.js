...
const CurriculumDetails = () => {
  ...
  const handleDescription = (e) => {
    setDescription({
      ...
      curriculum_description: e.target.getContent(),
    });
    // console.log(e.target.getContent())
    // console.log(description);
  };

  const [curriculum_description, setDescription] = useState("");
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      console.log(JSON.stringify(values, null, 2));
      console.log(
        mergeJSON.merge(JSON.stringify(values, null, 2), curriculum_description)
      );
      const result = await fetch(`${url}/admin/curriculum/add`, {
        method: "POST",
  ...
  return (
    <div className="content">
      <div className="upper">
        <h2 className="heading">Add Curriculum</h2>
        <Button
          variant="contained"
          color="secondary"
          className={classes2.button}
          startIcon={<AddIcon />}
          onClick={() => history.push("/curriculum/curriculum")}
        >
          View Curriculum
        </Button>
      </div>
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="inner-element">
              <FormsUI
                ...
                onChange={formik.handleChange}
                error={
                  formik.touched.curriculum_title &&
                  Boolean(formik.errors.curriculum_title)
                }
                helperText={
                  formik.touched.curriculum_title &&
                  formik.errors.curriculum_title
                }
              />
            </div>
            ...
            >
              ...
              <DialogContent dividers>
                ...
                <Typography gutterBottom style={{ fontSize: "15px" }}>
                  ...
                  {striptags(curriculum_description)}
                </Typography>
                <Typography gutterBottom style={{ fontSize: "15px" }}>
