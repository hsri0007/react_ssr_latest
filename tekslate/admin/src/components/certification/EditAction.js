...
const EditAction = (props) => {
  ...
  var s= props.data.certification_status===1 ? "active" : "inActive";
  ...
  const handleCloseAlert = (event, reason) => {
    history.push("/certification/certification");
    if (reason === "clickaway") {
      return;
    }
    setOpenAlert(false);
  ...
  const handleDescription = (e) => {
    setDescription({
      ...
      certification_description: e.target.getContent(),
    });

  };

  const [certification_description, setDescription] = useState(props.data.certification_description);
  ...
  const formik = useFormik({
    initialValues: {
      certification_title: `${props.data.certification_title}`,
    },
    validationSchema: validationSchema,
    onSubmit: async (values) => {
    
      const valueObj = JSON.stringify(values, null, 2);
      const descObj = JSON.stringify(certification_description);
      const mergedObject = {
        ...JSON.parse(valueObj),
        certification_description
      };
      ...
      const result = await fetch(
        `${url}/admin/certification/edit/${props.data.id}`,
        {
          method: "PUT",
  ...
  return (
    <div className="content">
      <div className="upper">
        <h2 className="heading">Update Certification</h2>
        <Button
          variant="contained"
          color="secondary"
          className={classes2.button}
          startIcon={<AddIcon />}
          onClick={() => history.push("/certification/certification")}
        >
          View Certification
        </Button>
      </div>
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className="inner-element">
            <FormsUI
              ...
              type="text"
              value={formik.values.certification_title}
              onChange={formik.handleChange}
              error={
                formik.touched.certification_title &&
                Boolean(formik.errors.certification_title)
              }
              helperText={
                formik.touched.certification_title &&
                formik.errors.certification_title
              }
            />
          </div>
          ...
          <div className="inner-element">
            ...
            {/* <Editor
              initialValue={props.data.certification_description}
              init={{
            ...
            <Editor
              ...
              value={certification_description}
          ...
          <div className="inner-element">
            ...
            >
              ...
              <DialogContent dividers>
                ...
                <Typography gutterBottom style={{ fontSize: "15px" }}>
                  <strong>Title:</strong> {formik.values.certification_title}
                </Typography>
                <Typography gutterBottom style={{ fontSize: "15px" }}>
                  <strong>Description:</strong>{" "}
                  {striptags(certification_description)}
                </Typography>
                <Typography gutterBottom style={{ fontSize: "15px" }}>
