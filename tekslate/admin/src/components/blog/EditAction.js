...
const EditAction = (props) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      const result = await fetch(`${url}/admin/blog/edit/${props.data.id}`, {
        method: "PUT",
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className="inner-element">
            <FormsUI
              ...
              onChange={formik.handleChange}
              error={formik.touched.url_title && Boolean(formik.errors.url_title)}
          ...
          <div className="inner-element">
            <FormsUI
              ...
              onChange={formik.handleChange}
              error={formik.touched.meta_desc && Boolean(formik.errors.meta_desc)}
            ...
            >
              ...
              <DialogContent dividers>
                <Typography gutterBottom style={{ fontSize: "15px" }}>
                  <strong>Category Name:</strong> {formik.values.blog_category}
                </Typography>
