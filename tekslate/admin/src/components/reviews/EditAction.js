...
const EditAction = (props) => {
  ...
  var s= props.data.r_status===1 ? "active" : "inActive";
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      console.log("IN REVIEWS"+description);
      ...
      // );
      const result = await fetch(`${url}/admin/review/edit/${props.data.id}`, {
        method: "PUT",
  ...
  return (
    <div className="content">
      <div className="upper">
        <h2 className="heading">Update Reviews</h2>
        <Button
          variant="contained"
          color="secondary"
