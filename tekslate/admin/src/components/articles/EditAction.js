...
const EditAction = (props) => {
  ...
  const [select, setSelect] = useState(props.data.id);
  const [openAutoComplete, setOpenAutoComplete] = React.useState(false);
  const [filter, setFilter] = useState("");
  const [courseName,setCourseName] = useState(props.data.author_name);
  ...
  const formik = useFormik({
    initialValues: {
      ...
      blog_category: `${props.data.blog_category}`,
      blog_type: `${props.data.blog_type}`,
      url_title: `${props.data.url_title}`,
      meta_title: `${props.data.meta_title}`,
      meta_desc: `${props.data.meta_desc}`,
      rating: `${props.data.rating}`,
      author: `${props.data.author}`,
      author_desc: `${props.data.author_desc}`,
    },
    ...
    onSubmit: async (values) => {
      ...
      const result = await fetch(`${url}/admin/article/edit/${props.data.id}`, {
        method: "PUT",
  ...
  return (
    <div className="content">
      <div className="upper">
        <h2 className="heading">Update Article</h2>
        <Button
          variant="contained"
          color="secondary"
        ...
        <div className="inner-element">
          ...
          <div className="inner-element">
            <FormsUI
              ...
              onChange={formik.handleChange}
              error={
                formik.touched.author_desc && Boolean(formik.errors.author_desc)
              }
              helperText={
