...
const Courses = ({ state }) => {
    ...
    const courses = stat.course.courses;
    return (
        <div>
            <section className={classes.section}>
                <Container maxWidth="md">
                    {courses.map((val, index) => {
                        // if (index === 0) console.log('*********this is val***********: ', val);
                        // if (index === 0) console.log('*********this is state.length***********: ', Object.keys(state).length);
                        if (Object.keys(state).length === 0 || (state[val.category] !== null && state[val.category] !== undefined && state[val.category] !== false)) {
                            return <Grid className={classes.coursecard} container spacing={3}>
                                <Grid item lg={9} md={9} sm={12} xs={12}>
                                    ...
                                    <Grid container spacing={3}>
                                        <Grid item lg={6} md={6} sm={12} xs={12}>
                                            <p className={classes.starbox}><StarIcon /><StarIcon /><StarIcon /><StarIcon /><StarHalfIcon />&nbsp;<span style={{ color: "grey" }}>&nbsp;{val.rating}({val.enrolled})</span></p>
                                        </Grid>
                                        <Grid style={{ padding: "12px" }} lg={6} md={6} sm={12} xs={12}>
                                            <p className={classes.timeBox}><QueryBuilderIcon className={classes.timeicon} />{val.duration} hours</p>
                                        </Grid>
                                    </Grid>
                                </Grid>
